...
plot.pca.published <- function(df,x,y,z,l,counts){
  ...
  shapes <- c(rep(gtex.shape,counts[1]),rep(tcga.shape,counts[2]))
  
  plot(p$x[,x],p$x[,y],pch=shapes,cex=0.7,cex.lab=1,col=colors,xlab=paste(paste("PC",x),round(v.x),"% of variance"),ylab=paste(paste("PC",y),round(v.y),"% of variance"),main=paste(z," FPKM n=",l))
...
# fig 1
pheatmap(cor(f.nozero), method="spearman", main="fig. 1b", show_colnames=FALSE, show_rownames=FALSE, annotation=annotation, annotation_row=annotation, annotation_legend=TRUE)
...
# fig 2
pheatmap(cor(f.log), method="spearman", main="fig. 2a log2", show_rownames=FALSE, show_colnames=FALSE, annotation=annotation, annotation_row=annotation, annotation_legend=TRUE)
...
# fig 3
pheatmap(cor(combat), method="spearman", main="fig. 3a COMBAT", show_rownames=FALSE, show_colnames=FALSE, annotation=annotation, annotation_row=annotation, annotation_legend=TRUE)
...
# Quantile Normalized
# fig 1
pheatmap(cor(qn.nozero), method="spearman", main="fig. 1b Quantile Normalized", show_colnames=FALSE, show_rownames=FALSE, annotation=annotation, annotation_row=annotation, annotation_legend=TRUE)
...
# fig 2
pheatmap(cor(qn.log), method="spearman", main="fig. 2a log2 Quantile Normalized", show_rownames=FALSE, show_colnames=FALSE, annotation=annotation, annotation_row=annotation, annotation_legend=TRUE)
...
# fig 3
pheatmap(cor(combat), method="spearman", main="fig. 3a COMBAT Quantile Normalized", show_rownames=FALSE, show_colnames=FALSE, annotation=annotation, annotation_row=annotation, annotation_legend=TRUE)
